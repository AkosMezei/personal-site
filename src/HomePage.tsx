...
function HomePage() {
    ...
    const styledComponents = {
        reactLink: <a href="https://react.dev" target="_blank" className="hover:text-react font-bold" />,
        typeScriptLink: <a href="https://www.typescriptlang.org" target="_blank" className="hover:text-typescript font-bold" />,
        dotnetLink: <a href="https://dotnet.microsoft.com/" target="_blank" className="hover:bg-gradient-to-bl hover:from-dotNetStart hover:from-45% hover:to-dotNetEnd hover:to-80% hover:text-transparent hover:bg-clip-text font-bold" />,
        viteLink: <a href="https://vite.dev" target="_blank" className="hover:bg-gradient-to-br hover:from-viteStart hover:from-45% hover:via-viteMiddle hover:via-50% hover:to-viteEnd hover:to-80% hover:text-transparent hover:bg-clip-text font-bold" />,
        tailwindLink: <a href="https://tailwindcss.com" target="_blank" className="hover:text-tailwind font-bold" />,
        framerMotionLink: <a href="https://motion.dev" target="_blank" className="hover:text-framerMotion font-bold" />,
        vercelLink: <a href="https://vercel.com/" target="_blank" className="hover:text-black/90 font-bold" />,
        mongoDBLink: <a href="https://www.mongodb.com" target="_blank" className="hover:text-mongoDB font-bold" />,
        dockerLink: <a href="https://www.docker.com" target="_blank" className="hover:text-docker font-bold" />,
        digitalOceanLink: <a href="https://www.digitalocean.com" target="_blank" className="hover:text-digitalOcean font-bold" />,
        javascriptLink: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" className="hover:text-javascript font-bold" />,
        pythonLink: <a href="https://www.python.org" target="_blank" className="hover:text-python font-bold" />,
        fastAPILink: <a href="https://fastapi.tiangolo.com" target="_blank" className="hover:text-fastAPI font-bold" />,
        flaskLink: <a href="https://flask.palletsprojects.com" target="_blank" className="hover:text-black dark:hover:text-white font-bold" />,
        postgresLink: <a href="https://www.postgresql.org" target="_blank" className="hover:text-postgres font-bold" />,
        plotlyLink: <a href="https://plotly.com" target="_blank" className="hover:text-plotly font-bold" />,
        threejsLink: <a href="https://threejs.org" target="_blank" className="hover:text-black dark:hover:text-white font-bold" />,
        geminiLink: <a href="https://ai.google.dev/gemini-api" target="_blank" className="hover:bg-gradient-to-r hover:from-geminiStart hover:to-geminiEnd hover:text-transparent hover:bg-clip-text font-bold" />,
        ...
        code: <code className="font-mono bg-slate-200 dark:bg-slate-700/80 text-sky-600 dark:text-sky-300 px-2 py-1 rounded-md text-sm" />,
    }
                    ...
                    <div>
                        ...
                        <ExpandableDiv
                            ...
                            expandedContent={
                                <ul>
                                    <li>
                                        {t('experience.internship.bullet_1')}
                                    </li>
                                    <li>
                                        {t('experience.internship.bullet_2')}
                                    </li>
                                    <li>
